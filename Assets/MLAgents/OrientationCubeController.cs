...
namespace Unity.MLAgentsExamples
{
    ...
    public class OrientationCubeController : MonoBehaviour
    {
        ...
        public void UpdateOrientation(Vector3 rootBPPosition, Vector3 targetPosition)
        {
            var dirVector = targetPosition - transform.position;
            //dirVector.y = 0; //flatten dir on the y. this will only work on level, uneven surfaces
            var lookRot =
                dirVector == Vector3.zero
                    ? Quaternion.identity
            ...
            //UPDATE ORIENTATION CUBE POS & ROT
            transform.SetPositionAndRotation(rootBPPosition, lookRot);
        }
    }
}
